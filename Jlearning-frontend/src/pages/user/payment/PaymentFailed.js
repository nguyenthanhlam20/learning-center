...
const PaymentFailed = () => {
  return (
    <>
      <section
        className={`lg:pb-28} relative z-10 pb-16 pt-36 md:pb-20 lg:pt-[180px] `}
      >
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[530px] text-center">
                <div className="mx-auto mb-9 text-center">
                  <SvgIcon color="error" sx={{ fontSize: "200px" }}>
                    <ErrorOutlineIcon />
                  </SvgIcon>
                </div>
                ...
                <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed">
                  Hãy thử thanh toán lại hoặc liên hệ nhân viên tư vấn
                </p>
                <Link
                  to="/"

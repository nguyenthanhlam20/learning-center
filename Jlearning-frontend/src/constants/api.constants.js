export const API = {
  ...
  MANAGE_CLASS: process.env.REACT_APP_MANAGE_CLASS,
  MANAGE_CLASS_MEMBER: process.env.REACT_APP_MANAGE_CLASS_MEMBER,
  MANAGE_REGISTRATION_FORM: process.env.REACT_APP_MANAGE_REGISTRATION_FORM,

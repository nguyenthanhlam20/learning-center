...
export const APP_CONSTANTS = {
  GOOGLE_CLIENT_ID:
    "790769126717-o3usrjk4jboct43090kr0es97v5d1v0r.apps.googleusercontent.com",
...
export const CONTACT_CONSTANTS = {
  TOP_HEADER: "Liên hệ",
  TOP_MESSAGE:
    "Vui lòng điền đầy đủ thông tin cần liên hệ. Lamsens sẽ cố gắng hồi đáp nhanh nhất yêu cầu của Quý khách hàng.",
  LEFT_HEADER: "Cần Trợ Giúp? Hãy Gửi Thông Điệp Tới Chúng Tôi!",
  LEFT_MESSAGE:
    "Đội ngũ hỗ trợ của chúng tôi sẽ sớm liên hệ lại với bạn qua email.",
  NAME: "Tên của bạn",
  EMAIL: "Email",
